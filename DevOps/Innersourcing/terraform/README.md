...
```
curl "https://nubesgen.com/demo-gh-toolkit.zip?iactool=TERRAFORM&region=francecentral&application=FUNCTION.consumption&runtime=DOTNET&database=NONE.free&addons=storage_blob&gitops=true" | tar -xzvf -
```
